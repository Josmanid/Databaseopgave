...
CREATE TABLE Facilities( Facility_id int NOT NULL PRIMARY KEY, Facility_Name VARCHAR(50) NOT NULL);
CREATE TABLE HotelFacilities(
    ID INT NOT NULL PRIMARY KEY,	
    Hotel_No int NOT NULL,
    Facility_id int NOT NULL,
    FOREIGN KEY (Hotel_No) REFERENCES Hotel(Hotel_No) ON UPDATE CASCADE ON DELETE CASCADE,
